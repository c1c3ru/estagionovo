...
class AppModule extends Module {
  ...
  void binds(Injector i) {
    ...
    i.addLazySingleton<PreferencesManager>(() => PreferencesManager(i<SharedPreferences>()));
    i.addLazySingleton<CacheManager>(() => CacheManager());

    // Repositories
    i.addLazySingleton<IAuthRepository>(() => AuthRepository(authDatasource: i(), preferencesManager: i()));
