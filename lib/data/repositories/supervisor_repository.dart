...
class SupervisorRepository implements ISupervisorRepository {
  ...
  SupervisorEntity _mapDataToSupervisorEntity(Map<String, dynamic> data) {
    return SupervisorEntity(
      ...
      user: null, // Assumindo que esta entidade é sempre um supervisor
    );
  }
  ...
  StudentEntity _mapDataToStudentEntity(Map<String, dynamic> data) {
    return StudentEntity(
      ...
      user: null, // Assumindo que StudentEntity sempre tem role student
    );
  }
  ...
  Future<Either<AppFailure, SupervisorEntity>> getSupervisorDetails(
    ...
    try {
      final supervisorData =
          await _supervisorDatasource.getSupervisorDataById(userId);
      if (supervisorData != null) {
        return Right(_mapDataToSupervisorEntity(supervisorData));
      } else {
        return Left(NotFoundFailure(
            message: 'Perfil de supervisor não encontrado para o ID: $userId'));
      }
    } on PostgrestException catch (e) {
      return Left(SupabaseServerFailure(
          message:
              'Erro do Supabase ao obter detalhes do supervisor: ${e.message}',
          originalException: e));
      ...
      return Left(ServerFailure(
          message:
              'Erro desconhecido ao obter detalhes do supervisor: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, List<StudentEntity>>> getAllStudents(
    ...
    try {
      ...
      final studentEntities =
          studentsData.map((data) => _mapDataToStudentEntity(data)).toList();
      return Right(studentEntities);
    } on PostgrestException catch (e) {
      return Left(SupabaseServerFailure(
          message:
              'Erro do Supabase ao obter lista de estudantes: ${e.message}',
          originalException: e));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          message: e.message, originalException: e.originalException));
      ...
      return Left(ServerFailure(
          message:
              'Erro desconhecido ao obter lista de estudantes: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, StudentEntity>> getStudentDetailsForSupervisor(
    ...
    try {
      final studentData =
          await _studentDatasource.getStudentDataById(studentId);
      if (studentData != null) {
        return Right(_mapDataToStudentEntity(studentData));
      } else {
        return Left(NotFoundFailure(
            message: 'Estudante não encontrado com ID: $studentId'));
      }
    } on PostgrestException catch (e) {
      return Left(SupabaseServerFailure(
          message:
  ...
  Future<Either<AppFailure, StudentEntity>> createStudent(
    ...
    try {
      ...
      final Map<String, dynamic> dataToCreate = {
        ...
        'internship_shift_1': studentData.internshipShift?.value,
        if (studentData.internshipShift != null)
          'internship_shift_2': studentData.internshipShift2!.value,
        'birth_date': studentData.birthDate.toIso8601String().substring(0, 10),
        'contract_start_date':
            studentData.contractStartDate.toIso8601String().substring(0, 10),
        'contract_end_date':
            studentData.contractEndDate.toIso8601String().substring(0, 10),
      ...
      final createdStudentData =
          await _studentDatasource.createStudentData(dataToCreate);
      return Right(_mapDataToStudentEntity(createdStudentData));
    } on PostgrestException catch (e) {
      return Left(SupabaseServerFailure(
          message: 'Erro do Supabase ao criar estudante: ${e.message}',
          originalException: e));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          message: e.message, originalException: e.originalException));
      ...
      return Left(ServerFailure(
          message: 'Erro desconhecido ao criar estudante: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, StudentEntity>> updateStudentBySupervisor(
    ...
    try {
      final Map<String, dynamic> dataToUpdate = {
        ...
        'internship_shift_1': studentData.internshipShift?.value,
        'internship_shift_2':
            studentData.internshipShift?.value, // Envia null se for null
        'birth_date': studentData.birthDate.toIso8601String().substring(0, 10),
        'contract_start_date':
            studentData.contractStartDate.toIso8601String().substring(0, 10),
        'contract_end_date':
      ...
      final updatedStudentData = await _studentDatasource.updateStudentData(
          studentData.id, dataToUpdate);
      return Right(_mapDataToStudentEntity(updatedStudentData));
    } on PostgrestException catch (e) {
      return Left(SupabaseServerFailure(
          message: 'Erro do Supabase ao atualizar estudante: ${e.message}',
          originalException: e));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          message: e.message, originalException: e.originalException));
      ...
      return Left(ServerFailure(
          message: 'Erro desconhecido ao atualizar estudante: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, void>> deleteStudent(String studentId) async {
    try {
      ...
      return Left(SupabaseServerFailure(
          message: 'Erro do Supabase ao remover estudante: ${e.message}',
          originalException: e));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          message: e.message, originalException: e.originalException));
      ...
      return Left(ServerFailure(
          message: 'Erro desconhecido ao remover estudante: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, List<TimeLogEntity>>> getAllTimeLogs({
    ...
    try {
      final timeLogsData = await _timeLogDatasource.getAllTimeLogsData(
        studentId: studentId,
        approved: pendingApprovalOnly == true
            ? false
            : null, // Se pendingOnly, approved deve ser false
      );
      ...
      return Left(SupabaseServerFailure(
          message:
              'Erro do Supabase ao obter todos os registos de tempo: ${e.message}',
          originalException: e));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          message: e.message, originalException: e.originalException));
      ...
      return Left(ServerFailure(
          message:
              'Erro desconhecido ao obter todos os registos de tempo: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, TimeLogEntity>> approveOrRejectTimeLog({
    ...
    required String
        supervisorId, // ID do supervisor que está a aprovar/rejeitar
    String?
        rejectionReason, // Não usado diretamente aqui, mas pode ser logado ou adicionado à descrição
  }) async {
    try {
      final Map<String, dynamic> dataToUpdate = {
        'approved': approved,
      ...
      final updatedTimeLogData =
          await _timeLogDatasource.updateTimeLogData(timeLogId, dataToUpdate);
      return Right(_mapDataToTimeLogEntity(updatedTimeLogData));
    } on PostgrestException catch (e) {
      return Left(SupabaseServerFailure(
          message:
              'Erro do Supabase ao aprovar/rejeitar registo de tempo: ${e.message}',
          originalException: e));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          message: e.message, originalException: e.originalException));
      ...
      return Left(ServerFailure(
          message:
              'Erro desconhecido ao aprovar/rejeitar registo de tempo: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, List<ContractEntity>>> getAllContracts(
    ...
    try {
      ...
      return Left(SupabaseServerFailure(
          message: 'Erro do Supabase ao obter contratos: ${e.message}',
          originalException: e));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          message: e.message, originalException: e.originalException));
      ...
      return Left(ServerFailure(
          message: 'Erro desconhecido ao obter contratos: ${e.toString()}',
          originalException: e));
    }
  }
  ...
  Future<Either<AppFailure, ContractEntity>> createContract(
      ContractEntity contractData) async {
    try {
      final Map<String, dynamic> dataToCreate = {
        ...
        'created_by':
            contractData.createdAt, // ID do auth.user que está a criar
      };
      final createdContractData =
