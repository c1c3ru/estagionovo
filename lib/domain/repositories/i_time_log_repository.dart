...
abstract class ITimeLogRepository {
  ...
  Future<TimeLogEntity> clockIn(String studentId, {String? description});
  ...
  Future<Map<String, dynamic>> getTotalHoursByStudent(String studentId, DateTime startDate, DateTime endDate);
  Future<Duration> getTotalHoursByPeriod(String studentId, DateTime start, DateTime end);
}
