...
class _SupervisorTimeApprovalPageState
  ...
  Future<void> _loadPendingApprovals() async {
    ...
    _supervisorBloc.add(
      const LoadAllTimeLogsForApprovalEvent(pendingOnly: true),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: const SupervisorAppDrawer(
        currentIndex: 2,
      ), // Ajuste o currentIndex conforme sua navegação
              ...
              Row(
                ...
                children: [
                  ...
                  if (log.supervisorId != null)
                    Text(
                      ' por ${_getSupervisorName(log.supervisorId!)}',
                      style: theme.textTheme.bodySmall?.copyWith(
                        color: theme.hintColor,
                      ),
                    ), // TODO: Implementar _getSupervisorName
                ],
              ),
          ],
        ),
