...
class ContractGanttChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final int totalDurationInDays = overallEndDate
        .difference(overallStartDate)
        .inDays;
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                DateFormat('dd/MM/yy').format(overallStartDate),
                style: theme.textTheme.bodySmall,
              ),
              Text(
                'Duração Total: $totalDurationInDays dias',
        ...
        Expanded(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final contractStartOffsetDays = contract.startDate
                  .difference(overallStartDate)
                  .inDays;
