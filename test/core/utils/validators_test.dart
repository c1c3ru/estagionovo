...
import 'package:estagio/core/utils/validators.dart';
  ...
  group('Validators', () {
    group('siapeRegistration', () {
      ...
      test('should return error for less than 7 digits', () {
        ...
        // Assert
        expect(result, equals('Matrícula SIAPE deve ter exatamente 7 dígitos.'));
      });
    ...
    group('siapeRegistrationUnique', () {
      test('should return null for valid and unique SIAPE', () {
        ...
        // Act
        final result = Validators.siapeRegistrationUnique(validSiape, isUnique: true);
      ...
      test('should return error for non-unique SIAPE', () {
        ...
        // Act
        final result = Validators.siapeRegistrationUnique(duplicateSiape, isUnique: false);
      ...
      test('should return basic validation error for invalid SIAPE', () {
        ...
        // Act
        final result = Validators.siapeRegistrationUnique(invalidSiape, isUnique: true);
